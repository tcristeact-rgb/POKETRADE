...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'cartas_ofrece' => [
            'required' => 'Pick at least one card to offer.',
            'min'      => 'Pick at least one card to offer.',
        ],
        'cartas_busca' => [
            'required' => 'Pick at least one card you want.',
            'min'      => 'Pick at least one card you want.',
        ],
    ],
    ...
    |
    | The field names are Spanish because the database columns are: without
    | this map an English user would read "The nombre field is required."
    |
    */
    ...
    'attributes' => [
        ...
        'password_nuevo'   => 'new password',
        'fecha_nacimiento' => 'date of birth',
        'nacionalidad'     => 'nationality',
        'avatar_url'       => 'avatar URL',
        'descripcion'      => 'description',
        'estado'           => 'status',
        'cartas_ofrece'    => 'cards you offer',
        'cartas_busca'     => 'cards you want',
        'carta_id'         => 'card',
        'cantidad'         => 'quantity',
        'tipo'             => 'type',
        'rareza'           => 'rarity',
